...
public class MyController6 {
  ...
  @GetMapping("/user/mypage.do")
  public String mypage2(@SessionAttribute(name="user") UserDto user) { // session attribute 중 user 를 UserDto user에 저장하시오.
    return "user/mypage";
  }
