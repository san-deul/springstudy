...
<body>
  ...
  <div>
    <form action="${contextPath}/upload1.do"
          method="post"
          enctype="multipart/form-data"> <!-- 파일첨부에서.method와enctype은 필수!! -->
          <!-- multipart는 multipart리졸버라는 객체가(bean)필요함 -->
      <div>
        <input type="file" name="files" class="files" accept="image/*" multiple> <!-- multiple:다중첨부,속성과 값이 동일하다면 값 생략 가능 -->
      </div>
      <div>
